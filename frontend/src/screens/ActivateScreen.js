...
const ActivateScreen = ({ location, history, match }) => {
  ...
  }, [history, formErrors, userInfo, userLoginInfo, redirect, tokenReceived]);
  ...
  return (
    <section className="bg-white flex-grow">
      <div className="mx-auto flex justify-center md:items-center relative">
        {tokenErrors ? (
          <div className="w-full sm:w-4/6 lg:w-6/12 xl:w-8/12 text-gray-600 mb-12 sm:mb-0 my-10 sm:my-6 px-6">
            <div className="pt-16 px-2 flex flex-col items-center justify-center">
              <h3 className="text-xl sm:text-2xl xl:text-xl font-bold leading-tight uppercase">
                <div className="text-center w-full text-sm bg-gray-100 text-red-500 rounded font-medium p-3 mt-8 leading-loose">
                  Invalid activation link. Please try again.
                </div>
              </h3>
              {/* <p className="mt-16 text-xl text-center uppercase">
                <Link className="text-indigo-600 ml-3 font-semibold" to="/">
                  Home
                </Link>
              </p> */}
