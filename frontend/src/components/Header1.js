    ...
    <>
      <div className="bg-gray-200 h-full w-full">
              ...
              <div className="w-full h-full flex items-center">
                <div className="w-full pr-12 h-full flex items-center border-gray-300 border-r">
                  <div className="relative w-full">
                    ...
                    <input
                      className="border border-gray-300 focus:outline-none focus:border-indigo-700 w-56 rounded text-sm text-gray-800 pl-8 py-2"
                      type="text"
                      placeholder="Search"
                    />
                  </div>
                ...
                <div className="w-full h-full flex">
                  <div className="w-32 h-full flex items-center justify-center text-gray-400 cursor-pointer">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
        ...
        <nav>
          ...
          >
            <div
              className="bg-gray-400 opacity-50 w-full h-full"
              onClick={() => setShow(!show)}
            />
                    ...
                    <div className="mt-6 flex w-full items-center justify-between">
                      <div className="flex items-center justify-between w-full">
                        <div className="flex items-center">
                          ...
                          <p className="text-base md:text-xl text-gray-800 ml-3">
                            The North
                          </p>
                        </div>
                        <div
                      ...
                      <a className="cursor-pointer">
                        <li className="text-gray-800 pt-10">
                          <div className="flex items-center">
                            ...
                            <p className="text-indigo-700 xl:text-base md:text-lg text-base ml-3">
                              Dashboard
                            </p>
                          </div>
                        </li>
                        ...
                        <li className="text-gray-800 pt-8">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center">
                              ...
                              <p className="text-gray-800 xl:text-base md:text-lg text-base ml-3">
                                Products
                              </p>
                            </div>
                          </div>
